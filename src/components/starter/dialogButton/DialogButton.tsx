  ...
  return (
    <div class="container-custom justify-end fixed right-[50%] translate-x-[50%] bottom-[30px] xl:bottom-[52px] pointer-events-none">
      <div class="flex flex-col items-center lg:items-end ">
        <div
          class={`w-[310px] flex pointer-events-auto items-center justify-center gap-2 lg:mr-10 bg-dark rounded-[40px] border-[6px] border-black outline outline-2 outline-purple transition relative z-10
          ${isActive.value ? "visible h-[80px] p-3" : "invisible p-0"}
          ${isOpen.value ? "translate-y-[50%]" : ""}
        `}
        >
          <button class="btn-gray-circle px-4">
            <svg
          ...
          <button
            ...
            class={`transition-all duration-500 z-5 ${
              isActive.value ? "scale-50" : "h-[124px] w-[124px]"
            }`}
